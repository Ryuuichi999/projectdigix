...
onMounted(async () => {
  try {
    ...
    Swal.fire({
      ...
      title: "ข้อผิดพลาด",
      text:
        "ไม่สามารถดึงข้อมูลหมวดหมู่ได้: " + (error.message || "Unknown error"),
...
const saveBook = async () => {
  try {
    ...
    Swal.fire({
      ...
      title: "ข้อผิดพลาด",
      text:
        "เกิดข้อผิดพลาดในการบันทึกหนังสือ: " +
    ...
    <div class="min-h-screen bg-gray-100 p-6 py-16">
      <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow">
        ...
        <form @submit.prevent="saveBook">
          ...
          <div class="mb-4">
            <label class="block text-gray-700 mb-2" for="published"
              >วันที่ตีพิมพ์</label
            >
            <input
              id="published"
          ...
          <div class="mb-4">
            <label class="block text-gray-700 mb-2" for="publisher"
              >สำนักพิมพ์</label
            >
            <input
              id="publisher"
